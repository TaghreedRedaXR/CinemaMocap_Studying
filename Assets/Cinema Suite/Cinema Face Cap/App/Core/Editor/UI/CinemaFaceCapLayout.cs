...
{
    /// <summary>
    /// Attribute for Layouts
    /// </summary>
    public class CinemaFaceCapLayoutAttribute : Attribute
    {
        // User friendly name
        ...
        public CinemaFaceCapLayoutAttribute(string profileName, int ordinal)
        {
    ...
    public abstract class CinemaFaceCapLayout
    {
        /// <summary>
        ...
        public static List<TypeLabelContextData> LoadMetaData()
        {
            ...
            List<Type> types = CinemaSuite.CinemaFaceCap.App.Core.Editor.Utility.Helper.GetLayoutProfiles();
            foreach (Type t in types)
            {
                foreach (CinemaFaceCapLayoutAttribute attribute in t.GetCustomAttributes(typeof(CinemaFaceCapLayoutAttribute), true))
                {
