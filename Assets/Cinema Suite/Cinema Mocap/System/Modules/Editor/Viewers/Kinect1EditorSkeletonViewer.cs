...
{
    [SensorEditorViewer("Skeleton Viewer", 2, SupportedDevice.Kinect1)]
    public class Kinect1EditorSkeletonViewer : Kinect1EditorViewer
    {
        // GUI
        ...
        /// <summary>
        /// Initialize the Kinect1 Skeleton Viewer
        /// </summary>
        ...
        private void UpdateTexture(/*ZigImage image,*/ ZigInputJoint[] userSkeleton)
        {
            ...
            for (int p = 0; p < textureSize.Height * textureSize.Width; ++p)
            {
                outputPixels[p] = Color.black;
            }
