...
namespace CinemaSuite.CinemaFaceCap.App.Core.Editor.UI
{
    ...
    public class SensorEditorViewerAttribute : Attribute
    {
        ...
        private SupportedDevice device = SupportedDevice.Kinect2;
    ...
    public abstract class SensorEditorViewer
    {
        ...
        {
            PlaceHolderImage = EditorGUIUtility.Load("Cinema Suite/Cinema Face Cap/FaceCap.png") as Texture2D;
            if (PlaceHolderImage == null)
            {
                UnityEngine.Debug.LogWarning("FaceCap.png is missing from Resources folder.");
            }
        }
        ...
        /// </summary>
        public virtual void DrawPlaceHolder()
        {
        ...
        internal static List<Type> GetSensorEditorViewers(params SupportedDevice[] devices)
        {
            ...
            foreach (Type type in Utility.Helper.GetAllSubTypes(typeof(SensorEditorViewer)))
            {
